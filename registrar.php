            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Faça um cadastro para publicar no NewsPira!</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        <h6 class="text-uppercase font-weight-bold mb-3">Cadastro</h6>
