            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Preencha o formulario para entrar em contato!</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        <h6 class="text-uppercase font-weight-bold mb-3">Entre em contato</h6>
                        <form action="./processar_reclama.php" method="post"> 
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control p-4" placeholder="Nome" required="required" name="nome" id="nome"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control p-4" placeholder="Assunto" required="required"  name="assunto" id="assunto"/>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" rows="4" placeholder="Mensagem" required="required" name="reclama" id="reclama"></textarea>
                            </div>
                            <div>
