...
<head>
    ...
    <title>NewsPira - Criar Noticia</title>
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Adicione uma noticia ao banco de dados do NewsPira!</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        <h6 class="text-uppercase font-weight-bold mb-3">Adicionar Noticia</h6>
                        <form action="processar_noticia.php" method="POST" enctype="multipart/form-data"> 
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control p-4" placeholder="autor" required="required"  name="autor" id="autor"/>
                                    </div>
                                    <div class="form-group">
                                        <input type="file" class="form-control p-4" placeholder="Imagem:" required="required"  accept="image/*" name="imagem" id="imagem "/>
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control" rows="4" placeholder="Resumo" required="required" name="resumo" id="resumo"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control" rows="4" placeholder="Noticia" required="required" name="texto" id="texto"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div>
