...
<head>
    ...
    <title>NewsPira - Classificados</title>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="Classificados.php" class="nav-item nav-link active">Classificados</a>
                </div>
            </div>
        </nav>
    </div>
    ...
    <?php
        require_once 'conecta.php'; 
        $consulta = "SELECT titulo, empresa, imagem, descrição, DATACADASTRO, stat FROM classificados WHERE stat = 1 ORDER BY DATACADASTRO DESC LIMIT 20";
        ...
        while($dado = $con->fetch_array()){
            ...
            echo '<a class="text-body" href=""><small>'.$dado["empresa"].'</small></a>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
