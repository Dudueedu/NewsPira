...
<head>
    ...
    <title>NewsPira - Criar Classificado</title>
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Adicione um Classificado ao banco de dados do NewsPira!</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        <h6 class="text-uppercase font-weight-bold mb-3">Adicionar Classificado</h6>
                        <form action="processar_classificado.php" method="POST" enctype="multipart/form-data"> 
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control p-4" placeholder="Titulo" required="required"  name="titulo" id="titulo"/>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control p-4" placeholder="empresa" required="required"  name="empresa" id="empresa"/>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control p-4" placeholder="link para comprar ingressos do filme:" required="required"  name="link" id="link"/>
                                    </div>
                                    <div class="form-group">
                                        <input type="file" class="form-control p-4" placeholder="Imagem:" required="required"  accept="image/*" name="imagem" id="imagem "/>
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control" rows="4" placeholder="Descrição" required="required" name="descricao" id="descricao"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div>
