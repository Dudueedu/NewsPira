...
<head>
    ...
    <title>NewsPira - Criar filme</title>
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Adicione um filme ao banco de dados do NewsPira!</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        <h6 class="text-uppercase font-weight-bold mb-3">Adicionar Filme</h6>
                        <form action="processar_filme.php" method="POST" enctype="multipart/form-data"> 
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control p-4" placeholder="Produtora do filme:" required="required"  name="produtora" id="produtora"/>
                                    </div>
                                    <div class="form-group">
